...
Settings.define :buffered_docs, :default => 10000, :description => "Number of documents to keep in memory before creating a bulk indexing request"
Settings.resolve!
...
class ParseMapper < Wukong::Streamer::StructStreamer
  ...
  def process tweet, *_
    ...
    if @aggregator.size == Settings.buffered_docs
