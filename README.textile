...
ES_DATA_ROOT=/mnt/elasticsearch
...
The best way to explain is with an example. Say you've got a tsv file of user records (name,login,email,description) and you want to index all the fields. I'm assuming you're going to write to an index called @users@ with objects of type @user@ (elasticsearch will create this object automatically the first time you upload one). The workflow is as follows:
...
<pre><code>
bin/estool --host=<elasticsearch_host> --index_name=users flush_index
</code></pre>
